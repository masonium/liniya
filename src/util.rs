...
mod tests {
    ...
    #[test]
    fn box_plane_test() {
	let aabb = AABB::from_half_extents(Point3::new(0.0, 0.0, 0.0),
					   Vector3::new(1.0, 1.0, 1.0));
	assert_eq!(box_plane_intersection(&aabb, &Vector4::new(0.0, 1.0, 0.0, -2.0)),
		   BoxPlaneTest::Outside);
	assert_eq!(box_plane_intersection(&aabb, &Vector4::new(0.0, 1.0, 0.0, 0.0)),
		   BoxPlaneTest::Intersects);
	assert_eq!(box_plane_intersection(&aabb, &Vector4::new(0.0, 1.0, 0.0, 2.0)),
		   BoxPlaneTest::Inside);
    }
